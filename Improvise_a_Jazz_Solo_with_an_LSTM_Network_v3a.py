...
# Run the following  to generate music and record it into your `out_stream`. This can take a couple of minutes.
...
# here is a 30 second audio clip we generated using this algorithm. 
